function [binary threshold globalcosteffmax costmax ef]=threshold_global_cost_efficiency_wd(w,th)
...
for i=1:th
    ...
    E=efficiency(binary.*w);
    E1=sum(sum(E));
    E1=E1/no;
    total=sum(binary(:)); % get the sum of indegree and outdegree
    cost(i)=total/no;
